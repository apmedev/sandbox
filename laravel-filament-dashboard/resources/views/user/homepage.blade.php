...
@section('content')
<!-- sections: search by game title, latest-best-deals(70% off) by marktplace - steam, playstation store, g2a  -->
<!-- section is carousel filled with cards. each card contains game with subscribe to game for price updates  -->
