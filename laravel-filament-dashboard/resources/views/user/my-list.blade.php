...
@section('content')
<!-- my-deals: grid view of subscribed games, each game is a card with option for click to view details in modal, actions:unsubsribe, notify when under %, notify when under $$  -->
