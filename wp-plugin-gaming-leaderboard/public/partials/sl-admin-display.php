...
<div class="wrap">
	...
	<div id="schortcode_display_box">
		<?php if (array_key_exists('custom_shortcode', $_GET)) { echo $_GET['custom_shortcode']; }else{ echo 'example shortcode: [-eaderboard-custom table_stats=challenges-won table_time=day games=all numrows=10]'; }?>
	</div>
	<br/><br/>
